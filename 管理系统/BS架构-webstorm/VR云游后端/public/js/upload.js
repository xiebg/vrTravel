    ...
    demoModule.directive('agPicture', ['$rootScope',
    	...
    	return {
 		   ...
 		   link: function(scope, element, attrs, ctrl) {
 		       ...
 		       var downloadUrl =  getServerPath()+'picture/download';
...
// 		           $fileLi = $compile($fileLi)(scope);
 		       ...
 		       function init_uploader() {
 		           ...
 		           uploader = WebUploader.create({
 		               ...
 		               dnd: '#dndArea',
 		               paste: '#uploader',
 		               swf: getJsPath()+'webuploader/Uploader',
 		               chunked: false,
 		               chunkSize: 512 * 1024,
 		               server: getServerPath()+'picture/upload',
 		               // runtimeOrder: 'flash',
 		               //限定图片
 		                accept: {
 		                    title: 'Images',
 		           ...
 		           uploader.on('uploadError', function(file, response) {
					   $('#wrapper').append(`<div style="color: red">上传失败！</div>`)
 		           ...
 		           uploader.on('uploadFinished', function() {
					   initPager();
 		               reboxPreview();
 		               console.log('上传完成');
						$('#wrapper').append(`<div style="color: red">上传成功！</div>`)
 		           });
