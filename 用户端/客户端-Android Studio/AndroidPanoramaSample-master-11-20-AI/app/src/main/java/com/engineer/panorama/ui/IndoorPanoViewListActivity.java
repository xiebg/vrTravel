...
public class IndoorPanoViewListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String AllURL = RequestInfo.BASEURL + "/indoor/findall";
        ...
        indoor_bt_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String NameURL = RequestInfo.BASEURL + "/indoor/findname"+"?name="+name;
...
//        String URL = RequestInfo.BASEURL + "/indoor/findall";
//        Log.d("HP",URL);
...
//                        public void run() {
                    ...
                    indoorPanoAdapter = new IndoorPanoAdapter(IndoorPanoViewListActivity.this,indoorpanoitem);
