package com.engineer.panorama.tf;
...
public class CameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TFUtils.copyFileFromAsset(CameraActivity.this, "mobilenet_v2.tflite", classificationModelPath);
        try {
    ...
    private void startCapture() {
        ...
        try {
            ...
            assert map != null;
            mPreviewSize = TFUtils.chooseOptimalSize(map.getOutputSizes(SurfaceTexture.class),
